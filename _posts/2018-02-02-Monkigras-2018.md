...
Every. Single. Speaker was excellent, and what's more the connections and synergies between their diverse topics and backgrounds was fascinating. Context matters. Trust matters. Skill and practise matters.

The hallway track was excellent - I had so many great conversations. The location was too noisy. There was nowhere quiet except the cold cold outdoors.
...
Consumers have to have trust in the supply chain because it is completely opaque, but this trust is abused (example: peanut butter which used to be only 75% peanuts). In being forced to trust the chain, consumers are disenfranchised and disempowered. Brutal phrase: 
  ...
  Wherefore sustainability in this? Removing layers allows increased trust - eg craft fairs, farmers markets.
  
  For me, this set a striking tone for what is nominally a tech conference. Hardly about tech at all, but a wide-ranging view on an industry which produces.
  
# Dormain Drewitz

  About her interest in letterpress printing, paralleled with her husband's interest in restoring vintage cars, and further paralleled with sustainability in software.
  ...
  Throughout the day I kept coming back to this, thinking about how it could apply to the hobbyist communities I have been part of. I'm delighted when I learn something new which can help me see something I know well in a new way.
...
# Chas Emerick
  ...
  He showed part of a paper in which the designers described their intention to entirely change the way that companies store and use documents. Scope of ambition that "makes my socks go up and down". (what is the goal of your current project?)
...
# Lars Trieloff
  ...
  AEM - Adobe's CMS, which by some imaginitive application of filters can in some way be considered the 3rd most popular in the world. It is also decades-old software.
...
How to make being on-call awesome. Ops has a history of masochism. But managed right on-call rotation is something people can **love** doing!
...
Sustainability and open-source. Using software used to have a lot of *friction*, ie negotiating enterprise licenses from a vendor. Now we are used to using OSS, is there no friction any more? (spoiler: there is)
...
Ethics in software. Piss and vinegar. "Ethical debt". Software is a young profession. Ethical standards change over time, which is **good**. Ethical professionals (ethics is what *defines* a professional) can be trusted. Links back to Aneel's theme of trusting a supply-chain.
...
Runing for political office in Argentina but found they had to obey the rules of the status quo in order to effectively challenge the status quo. Ugh.
...
Fashion industry slow-moving production model is broken. 10% of new clothes go straight to landfill as long lead-time means much waste. Zara has a 2-week lead time. Customized trainers are 25% of Nike's online sales.
...
Book recommendations: Daring Greatly, Mindset, Primal Leadership, Database Reliability Engineering.

# Amanda Whaley

Marie Curie. Parallels between Curie and OSS. Curie developed a method to refine (tiny amounts of) radium from (huge amounts of) pitchblende. But women in 1900s France were **not allowed to own property** (WTF!?) including Intellectual Property (ie patents) so the refining method was published (ie open-sourced). Curie sold contracting services and tools to people. Sound familiar?

Radium was ludicrously expensive so Curie didn't actually own any until a proto-kickstarter collected enough (and more) for her to own some.

# Ricardo Mendez

Craftsmanship - WTF does that even mean. Plastic food in restaurant windows in Japan *looks just like the food you will be served*. Someone in a no-name curry restaurant cares enough to do that - this is craftsmanship. Jiro (dreams of sushi) is less interesting because he's an example of survivor bias. Perfection is an end-state but craftsmanship is a process.
...
IBM's corporate design program. IBM employs 1600 designers. What kills or sustains culture? Culture sustains craft. People + practises + places = culture. So you can change people, practises and places in order to affect culture which leads to high quality craft.

Best practises evolve, craft is constant. A loop: Plan->reflect->do->reflect.

"Love your work". Compare with "don't get too attached" from Lars.

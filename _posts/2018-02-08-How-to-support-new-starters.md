...
IT has several issues with diversity. Recently the teams in my workplace took the chance to reflect on our place in this and we decided to hire several junior engineers. We were able to get several applicants through outreach to universities, internships, meetups and the hard work of our recruitment team but this post isn't about that. It's about the _next_ problem: **how to support junior engineers when they start working with us?**
